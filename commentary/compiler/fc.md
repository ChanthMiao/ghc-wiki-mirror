...
You can find a full description of FC in the paper [https://gitlab.haskell.org/ghc/ghc/-/wikis/reading-list\#TypeEqualities](https://gitlab.haskell.org/ghc/ghc/-/wikis/reading-list#TypeEqualities); note that GHC uses the system described in post-publication Appendix C, not the system in the main body of the paper.  The notes that follow sketch the implementation of FC in GHC, but without duplicating the contents of the paper.
