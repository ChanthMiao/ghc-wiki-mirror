...
*** Courses of Action
    ...
    - I took a deep dive into the core, stg of the lookup. First thing to notice
      ...
      Addendum (7-22-2021). These coercions get compiled away in the `Stg -> Cmm` pass. Specifically [here](https://gitlab.haskell.org/ghc/ghc/-/blob/master/compiler/GHC/StgToCmm/Prim.hs#L1089)
